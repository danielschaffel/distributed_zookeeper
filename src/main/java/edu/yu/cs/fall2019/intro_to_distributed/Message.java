...
public class Message
{
    ...
    public byte[] getNetworkPayload()
    {
        ...
        int bufferSize;
        // if(this.messageType == MessageType.WORK || this.messageType == MessageType.COMPLETED_WORK) {
        //     bufferSize = 40960;
        // } else {
            bufferSize = 30 + senderHostBytes.length + receiverHostBytes.length + this.contents.length;
        // }
